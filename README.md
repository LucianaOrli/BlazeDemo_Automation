...
Conclusão Técnica: O critério de aceitação (Percentil 90 < 2s) não foi plenamente satisfeito sob a carga máxima de 250 RPS. A análise dos logs indica que a infraestrutura pública (ambiente compartilhado) apresenta gargalos de rede e processamento sob alta concorrência.
